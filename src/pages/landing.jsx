...
const LandingPage = () => {
  return (
    <main className="flex flex-col gap-10 sm:gap-20 py-10 sm:py-20">
      ...
      {/* carousel */}
      <Carousel 
       plugins= {[Autoplay({delay:2000})]} className="w-full py-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4">{/* Cards */}
        <Card>
          ...
          <CardContent>
            Search and apply for jobs, track applicatons, and more.
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            Post jobs, manage applicatons, and find the best candidates.
          </CardContent>
        </Card>
      </section>
